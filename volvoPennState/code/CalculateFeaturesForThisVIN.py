...
#             print(f"Skipping calendar_day={dayCount} as it exceeds 2557.")
            ...
            file.writelines(f"Skipping calendar_day={dayCount} as it exceeds 2557.")
            file.close()
            return
...
#         print(f"🔓 Safely read from {vin_file_path}")
    ...
    # Assuming this is inside a loop or function where thisVIN, dayCount, and df_VINs are defined
    if df_VINs.loc[df_VINs['VIN'] == thisVIN, 'CALCULATION'].iloc[0] != 'FN':
        ...
        df_VINs.loc[df_VINs['VIN'] == thisVIN, ['TOTAL_ROWS', 'CALCULATION']] = [dayCount, 'FN']
